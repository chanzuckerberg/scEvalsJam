...
def parse_arguments():
    ...
    parser.add_argument("--data_path", type=str, default='./datasets/marson_prepped.h5ad')
    parser.add_argument("--graph_path", type=str, default='./graphs/marson_grn_128.pth')

    # parser.add_argument("--data_path", type=str, default='../1gene-norman.h5ad')
    # parser.add_argument("--graph_path", type=str, default=None)
    # parser.add_argument('--name', default='default_run')
    # parser.add_argument("--artifact_path", type=str, default="./artifacts/")
    ...
    old_args = dict(vars(parser.parse_args()))
