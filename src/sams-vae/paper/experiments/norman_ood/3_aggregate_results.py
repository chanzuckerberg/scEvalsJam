...
RESULTS_CSV_PATH = "results/norman_ood_results.csv"
PRECOMPUTED_URL = (
    "s3://insitro-research-2023-sams-vae/norman_ood/norman_ood_results.csv"
)
...
def load_results(sweep_id):
    ...
    for run in sweep.runs:
        ...
        for k, v in run.config.items():
            ...
            if k == "data_module_kwargs.frac_combinations_train":
