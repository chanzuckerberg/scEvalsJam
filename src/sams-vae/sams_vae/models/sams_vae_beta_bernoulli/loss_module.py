...
class SAMSVAEBetaBernoulli_ELBOLossModule(PerturbationPlatedELBOLossModule):
...
class SAMSVAEBetaBernoulli_CustomReweightedELBOLossModule(
    PerturbationPlatedELBOCustomReweightedLossModule
):
    def __init__(
        self,
        ...
        super().__init__(
            ...
            guide=guide,
            local_variables=["z_basal"],
            perturbation_plated_variables=["E", "mask", "mask_probs"],
...
class SAMSVAEBetaBernoulli_IWELBOLossModule(PerturbationPlatedIWELBOLossModule):
    def __init__(self, model: nn.Module, guide: nn.Module):
        super().__init__(
            model=model,
            guide=guide,
